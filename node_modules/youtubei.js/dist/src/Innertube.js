...
class Innertube {
    ...
    async getInfo(target, client) {
        ...
        if (__classPrivateFieldGet(this, _Innertube_session, "f").po_token) {
            extra_payload.serviceIntegrityDimensions = {
                poToken: __classPrivateFieldGet(this, _Innertube_session, "f").po_token
            };
        }
        const watch_response = watch_endpoint.call(__classPrivateFieldGet(this, _Innertube_session, "f").actions, extra_payload);
    ...
    async getBasicInfo(video_id, client) {
        ...
        const watch_response = await watch_endpoint.call(__classPrivateFieldGet(this, _Innertube_session, "f").actions, extra_payload);
        const cpn = generateRandomString(16);
    ...
    async getSearchSuggestions(query, previous_query) {
        ...
        const response = await __classPrivateFieldGet(this, _Innertube_session, "f").http.fetch_function(url, {
            headers: {
                'Cookie': __classPrivateFieldGet(this, _Innertube_session, "f").cookie || ''
            }
        });
